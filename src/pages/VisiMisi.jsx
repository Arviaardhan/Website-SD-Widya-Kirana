            ...
            <div className="max-w-2xl md:max-w-3xl lg:max-w-7xl mx-auto px-8 py-10 space-y-10 justify-start items-start">
                ...
                <div>
                    ...
                    <ol className="list-decimal list-outside pl-6 text-gray-700 space-y-2 leading-relaxed">
                        ...
                        <li className="text-gray-700 leading-relaxed font-normal tracking-wide text-xl">Membangun kualitas peserta didik memalui motivasi, pendidikan karakter</li>
                        <li className="text-gray-700 leading-relaxed font-normal tracking-wide text-xl">Meningkatkan mutu lulusan yang unggul dan mampu bersaing melalui pendidikan yang berkualitas</li>
